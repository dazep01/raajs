/**
 * RaaJS HTTP Client Extension v1.0
 * 
 * Philosophy:
 * - HTML-first, reactive-friendly, scope-aware
 * - Minimal but extensible, abort-safe, CSP-safe
 * - Thin directive layer over core request engine
 * 
 * Directive:
 *   raa-http:get, raa-http:post, raa-http:put, raa-http:patch, raa-http:delete
 *   raa-http:reactive, raa-http:lazy, raa-http:debounce, raa-http:throttle
 *   raa-http:poll, raa-http:headers, raa-http:query, raa-http:body
 *   raa-http:timeout, raa-http:response, raa-http:credentials, raa-http:confirm
 *   raa-on:http:success, raa-on:http:error, raa-on:http:finally, raa-on:http:abort
 */
(function () {
