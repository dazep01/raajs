/**
 * RaaJS Event Bus Extension | v2.2.0
 ...
 * sistem siaran lokal maupun global [1, 2].
 * ─────────────────────────────────────────────────────────────
 * ⚙️ DIREKTIF & API UTAMA
 * - raa-on:event:*  : Direktif untuk mendengarkan siaran pesan di HTML [1, 3].
 * - $bus            : Akses instan ke jalur komunikasi di dalam expression [4].
 * - RaaEvents.emit  : Mengirimkan pesan (siaran) ke seluruh pendengar [2, 5].
 * - RaaEvents.on    : Mendaftarkan pendengar untuk pesan tertentu (exact/wildcard) [5, 6].
 * - RaaEvents.local : Membuat frekuensi khusus untuk satu Root/Island tertentu [3, 5].
 * ─────────────────────────────────────────────────────────────
 * ⚖️ FILOSOFI TEKNIS
 * - Scope-aware, Namespaced (domain:action), Wildcard Support (*), 
 *   Auto-cleanup Lifecycle [1].
 * 
